            ...
            <div class="flex items-center gap-6">
                ...
                @auth
                    ...
                    <div x-data="notifications()" x-init="init()" class="relative">
                        ...
                        <div
                            ...
                            class="absolute right-0 mt-2 w-80 rounded-xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 shadow-xl overflow-hidden"
                            style="display: none;"
                        >
                            {{-- Panel header --}}
                            ...
                            {{-- Notification list --}}
                            <ul x-show="!loading && items.length > 0" class="max-h-80 overflow-y-auto divide-y divide-zinc-100 dark:divide-zinc-800">
                ...
                >
                    ...
                    <svg x-show="!isDark"
                        ...
                        x-transition:leave-start="opacity-100 rotate-0 scale-100"
                        x-transition:leave-end="opacity-0 -rotate-90 scale-50"
                        class="w-4 h-4 text-zinc-500 dark:text-zinc-400 absolute" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
