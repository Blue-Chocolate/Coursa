            ...
            <div :class="mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'"
                ...
                <div class="mb-8">
                    ...
                    <p class="text-zinc-500 dark:text-zinc-400 mt-2 text-sm">
                        New here?
                        <a href="{{ route('register') }}" class="text-amber-500 hover:text-amber-400 font-semibold transition-colors">Create an account →</a>
                    </p>
                </div>
                ...
                <form wire:submit="login"
                    ...
                    <div>
                        <div class="flex items-center justify-between mb-1.5">
                            ...
                            <a href="#" class="text-xs text-amber-500 hover:text-amber-400 font-medium transition-colors">Forgot password?</a>
                        </div>
