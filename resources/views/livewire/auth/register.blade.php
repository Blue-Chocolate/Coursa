...
<div class="min-h-screen flex font-['Sora'] antialiased">
    ...
    {{-- Dark mode toggle (uses darkMode() from layout <html> scope) --}}
    <button @click="toggle()"
            ...
            <div :class="mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'"
                ...
                <div class="mb-8">
                    ...
                    <p class="text-zinc-500 dark:text-zinc-400 mt-2 text-sm">
                        Already have one?
                        <a href="/login" class="text-amber-500 hover:text-amber-400 font-semibold transition-colors">Sign in →</a>
                    </p>
                </div>
                ...
                <form wire:submit="register" class="space-y-5">
                    ...
                    <div x-data="{ show: false }">
                        ...
                        <div class="relative">
                            <input wire:model="password" :type="show ? 'text' : 'password'" placeholder="Min. 8 characters" autocomplete="new-password"
                    ...
                    <p class="text-center text-xs text-zinc-400 dark:text-zinc-500">
                        ...
                        <a href="#" class="underline hover:text-zinc-600 dark:hover:text-zinc-300 transition-colors">Terms of Service</a>
                    </p>
