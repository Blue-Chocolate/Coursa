<div class="max-w-6xl mx-auto px-6 py-16">
    ...
    <div class="flex flex-col sm:flex-row gap-4 mb-10">
        <input wire:model.live.debounce.300ms="search"
               ...
               class="flex-1 px-4 py-3 rounded-xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 focus:outline-none focus:ring-2 focus:ring-amber-400 text-sm text-zinc-900 dark:text-zinc-100 placeholder-zinc-400" />

        <select wire:model.live="levelId"
                class="px-4 py-3 rounded-xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 text-sm text-zinc-900 dark:text-zinc-100 focus:outline-none focus:ring-2 focus:ring-amber-400">
            ...
            <a href="{{ route('course.show', $course->slug) }}"
               class="group block rounded-2xl overflow-hidden border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 hover:shadow-lg hover:border-amber-300 dark:hover:border-amber-600 transition-all duration-200">
                ...
                <div class="p-5">
                    ...
                    <h2 class="font-semibold text-base leading-snug group-hover:text-amber-500 transition-colors text-zinc-900 dark:text-zinc-100">
                        {{ $course->title }}
                    </h2>
