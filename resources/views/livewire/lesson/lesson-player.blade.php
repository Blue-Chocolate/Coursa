<div class="max-w-5xl mx-auto px-6 py-10"
    ...
    <nav class="text-sm text-zinc-400 mb-6 flex items-center gap-2">
        <a href="{{ route('course.show', $course->slug) }}" class="hover:text-amber-500 transition-colors">{{ $course->title }}</a>
        <span>/</span>
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        ...
        @if($isEnrolled)
            <div x-data="{ showModal: false }">
                <button @click="!completed && (showModal = true)"
                        :disabled="completed"
                ...
                <div x-show="showModal"
                    ...
                    <div x-transition:enter="transition ease-out duration-200"
                        ...
                        <h3 class="text-lg font-bold text-center mb-2 text-zinc-900 dark:text-zinc-100">Mark Lesson Complete?</h3>
                        ...
                        <div class="flex gap-3">
                            ...
                            <button @click="showModal = false; $wire.markComplete()"
